...
module.exports = {
  rules: {
    ...
    'noTableCharset_utf8mb4': [[/\s*DEFAULT\s+CHARSET\s*=\s*utf8mb4\s+COLLATE\s*=\s*utf8mb4_0900_ai_ci/i, '', 'out']],
  ...
  createRules(rules = []) {
    ...
    if (typeof rules == 'string') {
      ...
      newRules.push(...this.createRules(this.rules[rules]))
  ...
  format(sql, rules, outComment) {
    ...
    items.forEach((str, i) => {
      ...
      content += this._format(str, _rules)
    })
    return content.trim()
  },
