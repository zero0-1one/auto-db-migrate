...
module.exports = {
  rules: {
    ...
    'noSpaceAfterBracket': [[/\)\s*/g, ')', 'out']],
    'spaceBeforeBracket': [[/\s*\(/g, ' (', 'out']],
    'spaceAfterBracket': [[/\)\s*/g, ') ', 'out']],
    'noSpaceWrapBracket': ['noSpaceBeforeBracket', 'noSpaceAfterBracket'],
    'spaceWrapBracket': ['spaceBeforeBracket', 'spaceAfterBracket'],
    'noSpaceBeforeTypeBracket': [
      [/int(\s*)\(/gi, 'int(', 'out'],
      [/char(\s*)\(/gi, 'char(', 'out'],
    ],
